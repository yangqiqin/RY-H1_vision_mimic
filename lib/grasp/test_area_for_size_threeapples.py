...
# 放水果到右边纸箱
high_hover_pos_shuiguo = (-0.49, -0.355113 + offsety , 0.52)
    ...
    while take_objs:
        ...
        if results[0].masks is not None:
		    ...
		    # 步骤6：回高悬停位（过渡点）
                    ...
                    # 步骤8：降低高度在纸箱放置
                    target_pos = (high_hover_pos_shuiguo[0], high_hover_pos_shuiguo[1], 0.34 )
                    
                    if(num3>=1):
                        
                        target_pos = (high_hover_pos_shuiguo[0]-0.07*(num3/3),high_hover_pos_shuiguo[1]+0.07*(num3%3), 0.34 )
